...
**Depends only on:** `base`, `web` — installs on any Odoo 18 Community
...
Odoo 18 (Community or Enterprise). No other module dependency beyond `base`
and `web`.
